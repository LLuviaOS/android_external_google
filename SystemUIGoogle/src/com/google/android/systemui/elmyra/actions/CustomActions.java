    ...
    public void onTrigger(DetectionProperties detectionProperties) {
        ...
        switch (mActionSelection) {
            ...
            default:
                break;
            case 1: // Assistant
                lluviaUtils.switchScreenOn(getContext());
                mAssistManager.startAssist(new Bundle() /* args */);
                break;
            case 2: // Voice search
                if (isScreenOn) {
                    lluviaUtils.launchVoiceSearch(getContext());
                }
                break;
            case 3: // Camera
                lluviaUtils.switchScreenOn(getContext());
                lluviaUtils.launchCamera(getContext());
                break;
            case 4: // Flashlight
            ...
            case 6: // Volume panel
                if (isScreenOn) {
                    lluviaUtils.toggleVolumePanel(getContext());
                }
                break;
            case 7: // Screen off
                if (isScreenOn) {
                    lluviaUtils.switchScreenOff(getContext());
                }
                break;
            case 8: // Screenshot
                if (isScreenOn) {
